...
export default function AboutMe() {
  ...
  const boxes = [
    ...
    },
    {
      id: '32',
      title: '興味',
      desc: '私は音楽聴くことが好きで、特に EDM 系が大好きです。一番好きな EDM Artist は “Daft Punk" です。落ち込む時やあまり作業進まない時に音楽聴くとやる気が出ました。もう一つは言語を学ぶことです。私はいろんな国の言葉や文化を興味があって、暇な時に新しい言語を学んたり、POSTCARD 聞いたりします。今話せる言語としては「ミャンマー語・英語・日本語」です。',
      className: ' h-fit md:col-span-2',
      img: edm.src,
    },
