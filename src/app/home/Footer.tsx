...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div
        className='relative h-full sm:pt-14 p-10 bg-[#f7f7f7] text-black'
        ref={container}
      >
        <div className='sm:container  px-4 mx-auto'>
          <div className='md:flex justify-between w-full'>
            ...
            <div className='flex gap-10'>
              <ul>
                ...
                <li className='text-xl font-medium hover:text-green-500'>
                  <Link href='/'>Home</Link>
                </li>
                <li className='text-xl font-medium hover:text-green-500'>
              ...
              <ul>
                ...
                <li className='text-xl font-medium'>
                  <a
                    href='https://www.instagram.com/alexonic.29/'
                    target='_blank'
                    className='underline'
                  >
                    Instagram
                ...
                <li className='text-xl font-medium'>
                  <a
                    href='https://github.com/demonic29'
                    target='_blank'
                    className='underline'
                  >
                    Github
          ...
          <div className='flex md:flex-row flex-col-reverse gap-3 justify-between py-2'>
            <span className='font-medium'>
              &copy; 2025 aungkohtet. All Rights Reserved.
            </span>
