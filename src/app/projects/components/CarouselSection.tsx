    ...
    return (
        <div className="py-[40px]  gap-5 px-4 sm:px-6 bg-gray-50">
            ...
            <div className="relative container">
                {/* Navigation Buttons */}
                <div className="flex w-full justify-between md:absolute md:top-60 z-50">
                    <button ref={prevRef} className="bg-gray-500 text-white hover:bg-gray-800 hover:text-white p-3 rounded-full shadow-md transition-all duration-300">
                        <MdOutlineKeyboardArrowLeft className="w-8 h-8" />
                    </button>
                    <button ref={nextRef} className="bg-gray-500 text-white hover:bg-gray-800 hover:text-white p-3 rounded-full shadow-md transition-all duration-300">
                        ...
                        <SwiperSlide key={item.id}>
                           <section className='md:mx-[40px]'>
                                ...
                                <div className='grid md:mt-4 gap-2'>
                                    ...
                                    <Chip className={`md:text-[12px] text-white ${item.type === '個人制作' ? 'bg-gray-500' : 'bg-stone-900'}`}>{item.type}</Chip>
                                    <p className='md:text-[16px] md:tracking-wider md:leading-8'>{item.description}</p>
                                </div>

                                <button
                                    className="bg-stone-900 md:mt-8 hover:bg-stone-700 text-white md:px-16 md:py-3 md:text-[14px]"
