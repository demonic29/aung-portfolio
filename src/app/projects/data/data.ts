...
export const projectImages: ProjectImages[] = [
    {
        ...
        "type": "個人制作",
        "duration": "3日",
        "description": 'ミャンマーの有名な丘陵地帯の紅茶生産地域から、ロイヤル ミャンマー ティーミックスを紹介するサイトです。( このサイトはパソコンだけ見れます。　)',
    ...
    },
    {
        ...
        "description": `留学生たちは日本に来て色々大変なことがある中で、特に公共料金のお支払などに色々困っている方のために助けるお支払アプリ `,
    ...
    },
    {
        ...
        "description": `EDMとはエレクトロニック・ダンス・ミュージック）の略で、シンセサイザーなどの電子楽器を多用したダンスミュージックのジャンルです。( このサイトはパソコンだけ見れます。　)`,
...

    {
        ...
        "tools": [nextjs.src, firebase.src, tailwind.src],
        "description": `友達と共同でアルバムを作成し、写真やメモを通じて思い出を共有しいつでも思い出に浸れる。招待された友達は一緒にアルバムを作ることができ、思い出を共有する事ができる。( このサイトは携帯だけ見れます。)`,
        "tags": ['Pathway', 'Adventure', 'Peaks', 'Challenging', 'Breathtaking'],
...

    {
        ...
        "title": 'SPACE-TEA',
        "catchcopy": "宇宙系コーヒサイト",
        "description": `コーヒを飲みながら宇宙を感じることができる、学ぶことができるサイトです。( このサイトはパソコンだけ見れます。 )`,
        "tags": ['Pathway', 'Adventure', 'Peaks', 'Challenging', 'Breathtaking'],
        type: '個人制作',
        tools: [],
        duration: '2週間',
