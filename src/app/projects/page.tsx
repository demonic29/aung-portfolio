...
const Projects = () => {
  return (
    <div className="py-[40px] gap-5 px-4 sm:px-6 bg-gray-50">
      ...
      <div className="md:container grid gap-4 md:mb-[36px] text-center">
        <span className=" text-stone-700">Project Section</span>
        <h1 className="text-stone-900 md:text-5xl text-3xl font-[poppins] font-bold tracking-widest">
          EXPLORE MY PROJECTS
        </h1>
        <p className="text-stone-800 hidden md:block md:leading-8 md:tracking-widest">
